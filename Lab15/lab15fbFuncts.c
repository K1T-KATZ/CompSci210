...
//    inFile = fopen("C:\\Users\\C22Christopher.Katz\\Documents\\19_fall_school\\CompSci210\\Labs\\Lab15\\fbData.txt", "r"); // use this for working in CLion (comment when you submit)
